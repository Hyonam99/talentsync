    ...
    <div className="hero">
        ...
        <div className="Hero-image-display">
          <div className="image-grid">
            <div className="grid">
              <div className="grid-image-container grid-01">
                {/* <img src={image1} alt="" srcset="" /> */}
              </div>
              <div className="grid-image-container grid-02">
                {/* <img src={image2} alt="" srcset="" /> */}
              </div>
              <div className="grid-image-container grid-03">
                {/* <img src={image3} alt="" srcset="" /> */}
              </div>
            </div>
            <div className="grid">
              <div className="grid-image-container grid-04">
                {/* <img src={image4} alt="" srcset="" /> */}
              </div>
              <div className="grid-image-container grid-05">
                {/* <img src={image5} alt="" srcset="" /> */}
              </div>
              <div className="grid-image-container grid-06">
